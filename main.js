      ...
      (function () {
        ...
        (n = t(1)),
          ...
          (o = function (r) {
            var e, t, a, n, o;
            for (
              r = (r + "").replace(/\D/g, ""), t = void 0, a = 0, n = d.length;
              a < n;
              a++
            )
              (e = d[a]),
          ...
          (p = function (r) {
            ...
            if (
              ((e = r.target),
              (t = n.val(e)),
              !r.meta && 8 === r.which && !j(e))
            )
              return /\d\s$/.test(t)
                ? (r.preventDefault(),
                  n.val(e, t.replace(/\d\s$/, "")),
                  n.trigger(e, "change"))
                : /\s\d?$/.test(t)
                ? (r.preventDefault(),
                  n.val(e, t.replace(/\s\d?$/, "")),
                  n.trigger(e, "change"))
                : void 0;
          }),
          (f = function (r) {
          ...
          (u = function (r) {
            ...
            if ("/" === String.fromCharCode(r.which))
              return (
                ...
                (t = n.val(e)),
                /^\d$/.test(t) && "0" !== t
                  ? (n.val(e, "0" + t + " / "), n.trigger(e, "change"))
                  : void 0
              );
          }),
          (l = function (r) {
            ...
            if (
              !r.metaKey &&
              ((e = r.target), (t = n.val(e)), 8 === r.which && !j(e))
            )
              return /\d(\s|\/)+$/.test(t)
                ? (r.preventDefault(),
                  n.val(e, t.replace(/\d(\s|\/)*$/, "")),
          ...
          (x = function (r) {
            return function (e) {
              ...
              if (
                ...
                return (
                  (c = (n.val(d) + a).replace(/\D/g, "")),
                  (i = 16),
                  (t = o(c)) && (i = t.length[t.length.length - 1]),
                  r && (i = Math.min(i, r)),
          ...
          (k = function (r, e) {
            ...
            if (
              ...
              return (n.val(a) + t).replace(/\D/g, "").length > e
                ? r.preventDefault()
                : void 0;
          }),
          (y = function (r) {
          ...
          (v = function (r) {
            ...
            if (
              ...
              return (n.val(t) + e).length <= 4 ? void 0 : r.preventDefault();
          }),
          (z = function (r) {
            var e, t, o, i, c;
            if (
              ((i = r.target),
              (c = n.val(i)),
              (o = a.fns.cardType(c) || "unknown"),
              !n.hasClass(i, o))
            )
              return (
                (e = (function () {
                  var r, e, a;
                  for (a = [], r = 0, e = d.length; r < e; r++)
                    (t = d[r]), a.push(t.type);
                  return a;
                })()),
                ...
                validateCardNumber: function (r) {
                  ...
                  return (
                    ...
                    !!/^\d+$/.test(r) &&
                      !!(e = o(r)) &&
                      ((t = r.length),
                      $.call(e.length, t) >= 0 && (!1 === e.luhn || h(r)))
                  );
                },
                validateCardExpiry: function (e, t) {
                  ...
                  return (
                    "object" == typeof e && "month" in e
                      ...
                      : "string" == typeof e &&
                        $.call(e, "/") >= 0 &&
                        ((e = (d = r.fns.cardExpiryVal(e)).month),
                        (t = d.year)),
                    !(!e || !t) &&
                      ((e = n.trim(e)),
                      (t = n.trim(t)),
              ...
              (r.formatCardExpiry = function (e) {
                ...
                return (
                  ...
                  e.length && 2 === e.length
                    ? ((t = e[0]),
                      (a = e[1]),
                      this.formatCardExpiryMultiple(t, a))
                    : (n.on(e, "keypress", y),
                      n.on(e, "keypress", f),
                      n.on(e, "keypress", u),
                      n.on(e, "keypress", g),
